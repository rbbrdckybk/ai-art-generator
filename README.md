...
<img src="/samples/sample01.jpg" width="366" alt="sample image created with Stable Diffusion process" title="sample image created with Stable Diffusion process">
<img src="/samples/sample02.jpg" width="220" alt="sample image created with Stable Diffusion process" title="sample image created with Stable Diffusion process">
<img src="/samples/sample03.jpg" width="220" alt="sample image created with VQGAN+CLIP process" title="sample image created with VQGAN+CLIP process">
<img src="/samples/sample04.jpg" width="220" alt="sample image created with Stable Diffusion process" title="sample image created with Stable Diffusion process">
<img src="/samples/sample05.jpg" width="220" alt="sample image created with Stable Diffusion process" title="sample image created with Stable Diffusion process">
